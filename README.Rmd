...
-Doing linear and logistic regressions of large quantities of health data to improve treatment (package: biglm)
...
The two functions were compared with each other. The funalt() function completed the job quicker than the fun1() function, and it was around 16.5 times faster. 
